...
/**
 * Contexto interno usado por PromptBuilder para armar los prompts.
 * Es un detalle de implementación del backend: no viaja por la red
 * (los contratos que sí viajan están en el módulo `common`, paquete
 * com.cuevas.powerspike.analysis).
 */
